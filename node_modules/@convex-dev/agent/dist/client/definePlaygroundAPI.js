...
import { vMessageDoc, vThreadDoc, vPaginationResult, vMessage, vContextOptions, vStorageOptions, } from "@convex-dev/agent";
...
export function definePlaygroundAPI(component, { agents: agentsOrFn, userNameLookup, }) {
    ...
    const generateText = actionGeneric({
        ...
        handler: async (ctx, args) => {
            ...
            const { messageId, text } = await thread.generateText({ ...rest, ...(system ? { system } : {}) }, {
                contextOptions,
                storageOptions,
            });
