...
export const vThreadStatus = v.union(v.literal("active"), v.literal("archived"));
...
export const vReasoningDetails = v.array(v.union(v.object({
    type: v.literal("text"),
    text: v.string(),
    signature: v.optional(v.string()),
}), v.object({
...
export const vAssistantContent = v.union(v.string(), v.array(v.union(vTextPart, vFilePart, vReasoningPart, vRedactedReasoningPart, vToolCallPart)));
...
export const vFinishReason = v.union(v.literal("stop"), v.literal("length"), v.literal("content-filter"), v.literal("tool-calls"), v.literal("error"), v.literal("other"), v.literal("unknown"));
export const vUsage = v.object({
    promptTokens: v.number(),
    completionTokens: v.number(),
    totalTokens: v.number(),
});
export const vLanguageModelV1CallWarning = v.union(v.object({
...
export const vTextStreamPart = v.union(v.object({
...
export const vStreamArgs = v.optional(v.union(v.object({
    kind: v.literal("list"),
